			...
			if (jq("#theFrame").length == 0) {
				...
				if ((s != "") && (s != null)) {
					...
					<div id='theFrame'>\
						...
						<iframe style='background-color:white' scrolling='no' src='http://localhost:8080/jasperserver-pro56_Beta/flow.html?_flowId=viewReportFlow&reportUnit=/public/Samples/VisualizeJS/ProductDetails&parProductId=" + s + "&viewAsDashboardFrame=true' onload=\"window.jQuery('#theFrame iframe').slideDown(500);\">Enable iFrames.</iframe>\
						<style type='text/css'>\
