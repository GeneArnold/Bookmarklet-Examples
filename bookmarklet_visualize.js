...
(function(){
	...
	if (window.visualize === undefined) {
		var done = false;
		var script = document.createElement("script");
		script.src = "http://localhost:8080/jasperserver-pro/client/visualize.js";
			...
			if (jq("#theFrame").length == 0) {
				...
				if ((s != "") && (s != null)) {
					...
					<div id='theFrame'>\
						...
						<div id='report' style='background-color:white' scrolling='no' onload=\"window.jQuery('#theFrame <div>').slideDown(500);\"></div>\
						<style type='text/css'>\
							...
							#report { position: fixed; top: 25%; left: 35%; width: 300px; height: 400px; z-index: 999; border: 5px solid rgba(0,0,0,.5); margin: 0 0 0 0; }\
						</style>\
					</div>");
